...
const roles: [string, ...string[]] = ["Student ambassador", "Mentor", "None"];
      ...
      >
        <div className="flex-1">
          <p className="text-rmit text-center mb-4">
            Would you be interested in joining the <br /> Sustainability Ambassador Program <br />{" "}
            and receiving further information?
          </p>
          <FormField
